...
[![GitHub Repo Size](https://img.shields.io/github/repo-size/AaryanK47/Wipro-TalentNext-Practise?style=for-the-badge&color=blueviolet)](https://github.com/AaryanK47/Wipro-TalentNext-Practise)
...
### Running the Program:
Once compiled, run the bytecode using:
```bash
java Filename
```
...
Developed with ❤️ as part of the Wipro TalentNext training track.

* **GitHub:** [@AaryanK47](https://github.com/AaryanK47)
